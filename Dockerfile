...
COPY ./FreeBASIC-1.05.0-linux-x86_64.tar.gz \
	...
	./ic17int_linux64_2017-10-27.zip \
	/usr/local/
...
RUN cd /usr/local/ \
	...
	&& cp -r * /usr/ \
	&& cd .. \
	&& unzip ./ic17int_linux64_2017-10-27.zip -d ./ic17int_linux64_2017-10-27 \
	&& cp ./ic17int_linux64_2017-10-27/ic17int /usr/bin/ \
